...
public class URLHelper {
    //  public static String base = "http://45.32.71.202/";

   /* public static final String base = "http://omninos.com/golimo/" +
            "";*/

    public static final String base = "http://app.waylonsafaris.com/";
    ...
    public static String HELP_URL = "http://waylonsafaris.com/";
